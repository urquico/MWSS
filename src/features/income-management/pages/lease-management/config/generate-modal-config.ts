...
export const generateModalConfigs: Record<string, GenerateModalConfig> = {
  'statement-of-account': {
    fields: [
    { name: 'lessee', label: 'Lessee', description: 'Last Name, First Name, & Middle Name', value: "", span: 12 },
    { name: 'location', label: 'Location', value: "", span: 3 },
    { name: 'principal', label: 'Principal', value: "", span: 3 },
    { name: 'retailAdjustment', label: 'Retail Adjustment', value: "", span: 3 },
  ...
  'billing-statement': {
    ...
    fields: [
      { name: 'lessee', label: 'Lessee', description: 'Last Name, First Name, & Middle Name', value: "Reyes, Maria Clara", span: 12 },
      { name: 'location', label: 'Location', value: "456 Business Ave, Cebu City", span: 3 },
      { name: 'totalArea', label: 'Total Area', value: "200 sqm", span: 3 },
      { name: 'monthlyRental', label: 'Monthly Rental', value: "₱30,000.00", span: 3 },
      { name: 'rentalPeriod', label: 'Rental Period', value: "March 2024 - February 2026", span: 3 }
    ],
    tableData: [
      { date: '2024-03-01', principal: 30000, arrearages: 0, interest: 0, vat: 3600, gross: 33600, payment: 33600, orNo: '98765' },
    ],
    columns: [
      { accessorKey: 'date', header: 'Date' },
      { accessorKey: 'principal', header: 'Principal (a)' },
